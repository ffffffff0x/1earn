...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/4.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/5.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/6.png)

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/7.png)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/8.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/9.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/21.png)

保存后打开“工具-开发板-开发板管理器”，在“贡献”类型中找到“esp8266”，点击安装

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/22.png)

> 注:如果速度慢可以配置代理

可以在“工具-开发板”中找到“Generic ESP8266 Module”。选择它，并将其它设置（如Flash Size等）调整到如下图所示：

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/23.png)

具体的烧录的方法是，将 ESP8266 芯片的 TXD0、RXD0、VCC、GND、GPIO0 连接到 USB2TTL 上。

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/19.png)

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/10.jpg)

连接完成后，将 USB2TTL 插上电脑的 usb 端口。

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/11.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/24.png)

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/24-2.png)

接下来是板上元器件的焊接，相关的物料清单如下：

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/25.png)

焊接的顺序最好是 CH9350-AMS1111-电容-USB 插接件-ESP8266 模块。**ESP8266 一定要先烧录**

焊接完成后的成品是这样的：  *可以视需求安装 ESP8266-07S 的天线，因为其自带的天线信号一般，距离不是很远*

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/26.jpg)
...
![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/28.jpg)

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/27.jpg)

通电后,手机搜索 wifi,找到相应 wifi,连接,访问对应 url

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/31.jpg)

尝试输入 hello,world 可以发现,网页上已经成功读取

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/30.jpg)

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/29.jpg)

访问 /clear,清空

![](../../../../../assets/img/Security/IOT/硬件设备/HID/HID-USBKeyLogger/32.jpg)
