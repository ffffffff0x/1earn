...
**Windows系统漏洞**
- 见 [OS-Exploits](../漏洞利用/OS-Exploits.md#windows)

**域**
- 见 [OS-Exploits](../漏洞利用/OS-Exploits.md#域)
...
linux 提权需要掌握系统的许多信息,命令参见笔记 [信息](../../../../Integrated/Linux/笔记/信息.md) 内容

**Linux系统漏洞**
- 见 [OS-Exploits](../漏洞利用/OS-Exploits.md#linux)
