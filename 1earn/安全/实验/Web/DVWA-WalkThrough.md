...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa1.png)
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa2.png)
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa3.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa4.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa5.png)

3. 选中 Payloads,载入字典,点击 Start attack 进行爆破
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa6.png)
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa7.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa8.png)

2. Username :admin' # Password :(空),此时 sql 语句如下图:
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa9.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa10.png)
...
for key in open("password.txt"):
    ...
    if (i == 100):
        break
```
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa11.png)
...
```
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa12.png)
...
```
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa13.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa14.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa82.png)
...
phpstudy开一下这2个参数
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa15.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa16.png)
...
- **构造url(相对路径)**
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa19.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa20.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa23.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa24.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa27.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa28.png)
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa29.png)

**抓包修改文件类型**
上传 shell.png 文件,抓包.

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa30.png)

可以看到文件类型为 image/png,尝试修改 filename 为 shell.php.

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa31.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa32.png)

可以看到,包中的文件类型为 image/png,可以通过文件类型检查.上传成功.
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa33.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa34.png)

打开可以看到,一句话木马藏到了最后.顺利通过文件头检查,可以成功上传.

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa35.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa36.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa37.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa38.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa39.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa40.png)

更改参数 recaptcha_response_field 以及 http 包头的 User-Agent

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa41.png)
...
1. 判断是否存在注入,注入是字符型还是数字型
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa42.png)

    输入 `1'and '1' ='2`,查询失败,返回结果为空:

    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa43.png)

    输入 `1'or '1'='1`,查询成功:

    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa44.png)
...
2. 猜解SQL查询语句中的字段数
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa45.png)

    输入 `1' or 1=1 order by 2 #`,查询成功
    输入 `1' or 1=1 order by 3 #`,查询失败:

    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa46.png)
...
3. 确定显示的字段顺序
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa47.png)
...
4. 获取当前数据库
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa48.png)
...
5. 获取数据库中的表
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa49.png)
...
6. 获取表中的字段名
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa50.png)
...
7. 获取数据
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa51.png)
...
8. 猜 root 用户
	...
	![](../../../../assets/img/安全/实验/Web/dvwa/dvwa76.png)
...
9. 读文件和写入拿 webshell
	...
	![](../../../../assets/img/安全/实验/Web/dvwa/dvwa77.png)
	...
	- **利用 `into outfile()` 函数写入一句话拿 webshell**
		...
		![](../../../../assets/img/安全/实验/Web/dvwa/dvwa80.png)
...
1. 判断是否存在注入,注入是字符型还是数字型
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa52.png)
...
2. 猜解 SQL 查询语句中的字段数
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa53.png)
...
3. 确定显示的字段顺序
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa54.png)
...
6. 获取表中的字段名
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa55.png)
    ...
    ![](../../../../assets/img/安全/实验/Web/dvwa/dvwa56.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa57.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa58.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa59.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa60.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa61.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa62.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa63.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa64.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa81.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa65.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa66.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa67.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa68.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa69.png)

但如果有人将 callback 参数改成 `callback=alert(document.cookie)` 呢？
返回的会是 `alert(document.cookie)//({"answer":"15"}) `...
所以这是一个注入点

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa70.png)

![](../../../../assets/img/安全/实验/Web/dvwa/dvwa71.png)
...
<p align="center">
    <img src="../../../../assets/img/安全/实验/Web/dvwa/dvwa72.png">
</p>
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa73.png)
...
![](../../../../assets/img/安全/实验/Web/dvwa/dvwa74.png)
...
<p align="center">
    <img src="../../../../assets/img/安全/实验/Web/dvwa/dvwa75.png">
</p>
