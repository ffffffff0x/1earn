...
![wifi选项](../../../../assets/img/安全/笔记/RedTeam/安卓渗透/1.png)

![高级设置](../../../../assets/img/安全/笔记/RedTeam/安卓渗透/2.png)

**安卓模拟器<--->Proxifier 代理<--->Burp**

代理服务器设置为 burp 监听端口

![高级设置](../../../../assets/img/安全/笔记/RedTeam/安卓渗透/3.png)

![高级设置](../../../../assets/img/安全/笔记/RedTeam/安卓渗透/4.png)

已夜神模拟器为例,使用的网络进程有：`NoxVMHandle Frontend`

![高级设置](../../../../assets/img/安全/笔记/RedTeam/安卓渗透/5.png)
