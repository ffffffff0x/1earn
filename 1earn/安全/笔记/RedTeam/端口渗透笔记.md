...
- CVE-2015-7547
- [域传送漏洞](./业务协议渗透笔记.md#DNS) 现在域传送漏洞也少了,可以考虑的方向是子域名接管
...
- [CVE-2018-1111 DHCP 客户端脚本代码执行漏洞](./业务协议渗透笔记.md#DHCP)
...
- [CVE-2012-1675 爆破TNS](./业务软件渗透笔记.md#oracle)
- 爆破弱口令
...
- 弱口令
- [weblogic渗透](./web服务和中间件渗透笔记.md#Weblogic)
