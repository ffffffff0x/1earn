...
**注入**
- [MSSQL数据库注入笔记](./SQLi.md#MSSQL)

**提权**

关于 MSSQL 提权内容,见笔记 [权限提升](./权限提升.md#MSSQL) MSSQL 提权部分
...
**注入**
- [Mysql数据库注入笔记](./SQLi.md#Mysql)

**提权**

关于 mysql 提权内容,见笔记 [权限提升](./权限提升.md#Mysql) mysql 提权部分
