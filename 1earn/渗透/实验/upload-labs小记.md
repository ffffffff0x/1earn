...
![image](../../../assets/img/渗透/实验/upload-labs/5.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/6.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/7.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/8.png)

## Pass-12-00 截断

![image](../../../assets/img/渗透/实验/upload-labs/9.png)

img_path 依然是拼接的路径，但是这次试用的 post 方式，还是利用 00 截断，但这次需要在二进制中进行修改，因为 post 不会像 get 对 %00 进行自动解码

![image](../../../assets/img/渗透/实验/upload-labs/10.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/11.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/12.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/13.png)
...
- **写入 PLTE 数据块**
    ...
    1. 在 PLTE 数据块写入 php 代码
        ...
        ![image](../../../assets/img/渗透/实验/upload-labs/14.png)
    ...
    3. 修改 CRC 值
        ...
        ![image](../../../assets/img/渗透/实验/upload-labs/15.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/19.png)

![image](../../../assets/img/渗透/实验/upload-labs/20.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/16.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/17.png)
...
![image](../../../assets/img/渗透/实验/upload-labs/18.png)
